import { USDC_ADDRESS, USD_ADDRESS, WETH9_ADDRESS, WNATIVE_ADDRESS, SUSHI_ADDRESS, CNDL_ADDRESS } from './addresses'
...
export const CNDL: ChainTokenMap = {
  [ChainId.ETHEREUM]: new Token(ChainId.ETHEREUM, CNDL_ADDRESS[ChainId.ETHEREUM], 18, 'CNDL', 'CandleToken'),
  [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, CNDL_ADDRESS[ChainId.ROPSTEN], 18, 'CNDL', 'CandleToken'),
  [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, CNDL_ADDRESS[ChainId.RINKEBY], 18, 'CNDL', 'CandleToken'),
  [ChainId.MATIC]: new Token(ChainId.MATIC, CNDL_ADDRESS[ChainId.MATIC], 18, 'CNDL', 'CandleToken'),
